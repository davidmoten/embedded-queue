...
import org.davidmoten.eq.internal.StoreWriter;
import org.davidmoten.eq.internal.WriteHandler;
...
public class Store extends Completable implements IStore, StoreWriter {
